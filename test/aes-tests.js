...
generateAlgorithm(key, {encoding: 'hex', file: 'test/fixtures/wbaes-smoke.js'});
...
module.exports = {
    ...
    'RFC 3686, Test vector 1' : function(test) {
        ...
        generateAlgorithm(key, {encoding: 'hex', file: 'test/fixtures/wbaes-rfc3686-1.js'});
    ...
    'RFC 3686, Test vector 2' : function(test) {
        ...
        generateAlgorithm(key, {encoding: 'hex', file: 'test/fixtures/wbaes-rfc3686-2.js'});
    ...
    'RFC 3686, Test vector 3' : function(test) {
        ...
        generateAlgorithm(key, {encoding: 'hex', file: 'test/fixtures/wbaes-rfc3686-3.js'});
    ...
    'MBS AES-CTR, Test Vector 1' : function(test) {
        ...
        generateAlgorithm(key, {encoding: 'hex', file: 'test/fixtures/wbaes-mbs-1.js'});
    ...
    'MBS AES-CTR, Test Vector 2' : function(test) {
        //http://www.ieee802.org/16/tge/contrib/C80216e-04_357.pdf
        var key = '0000000000000000ffffffffffffffff';
        generateAlgorithm(key, {encoding: 'hex', file: 'test/fixtures/wbaes-mbs-2.js'});
    ...
    'MBS AES-CTR, Test Vector 3' : function(test) {
        //http://www.ieee802.org/16/tge/contrib/C80216e-04_357.pdf
        var key = '0000000000000000ffffffffffffffff';
        generateAlgorithm(key, {encoding: 'hex', file: 'test/fixtures/wbaes-mbs-3.js'});
